...
public class IdentifierGeneratorDefinition implements Serializable {
    ...
    public IdentifierGeneratorDefinition(final String name, final String strategy,
    ...
    public IdentifierGeneratorDefinition(final String name, final Map<String, String> parameters) {
    ...
    public String toString() {
        return "IdentifierGeneratorDefinition{" + "name='" + name + '\'' + ", strategy='" + strategy + '\''
