...
/*
	@Override
	public Object nullSafeGet(ResultSet rs, String name, Session session, Object owner)
	...
	@Override
	public void nullSafeSet(PreparedStatement st, Object value, int index, boolean[] settable, Session session)
			throws SQLException {
	...
	@Override
	public void nullSafeSet(PreparedStatement st, Object value, int index, Session session)
			throws SQLException {
		requireIdentifierOrUniqueKeyType( session.getFactory() )
...
*/
	 ...
	 */
	/*protected final Object resolveIdentifier(Serializable id, Session session, Boolean overridingEager) throws
			MyjpaException {
