...
import cn.sexycode.mybatis.jpa.util.PersistentUtil;
...
public class MyTableInfoHelper {
    ...
    private static final Log logger = LogFactory.getLog(MyTableInfoHelper.class);
    ...
    public static void initTableFields(Class<?> clazz, GlobalConfig globalConfig, TableInfo tableInfo) {
        ...
        if (StringUtils.isEmpty(tableInfo.getKeyColumn())) {
            logger.warn(String.format("Warn: Could not find @Id in Class: %s.", clazz.getName()));
        }
    }
        ...
        if (tableId != null) {
            ...
            if (generatedValue != null) {
                ...
                if (StringUtils.isEmpty(tableInfo.getKeyColumn())) {
                    ...
                    /* 字段 */
                    String column = PersistentUtil.getColumnName(field, false);
    ...
    public static List<Field> getAllFields(Class<?> clazz) {
        return PersistentUtil.getPersistentFields(clazz);
    }
