...
import cn.sexycode.myjpa.query.criteria.internal.expression.PathTypeExpression;
 ...
 */
public abstract class AbstractPathImpl<X> extends ExpressionImpl<X>
    ...
    protected final RuntimeException illegalDereference() {
        return new IllegalStateException(
                String.format("Illegal attempt to dereference path source [%s] of basic type", getPathIdentifier()));
    ...
    protected final Path resolveCachedAttributePath(String attributeName) {
        return attributePathRegistry == null ? null : attributePathRegistry.get(attributeName);
    }
    ...
    public <Y> Path<Y> get(SingularAttribute<? super X, Y> attribute) {
        ...
        if (path == null) {
            path = new SingularAttributePath<Y>(criteriaBuilder(), attribute.getJavaType(), getPathSourceForSubPaths(),
                    attribute);
    ...
    public <Y> Path<Y> get(String attributeName) {
        ...
        if (attribute.isCollection()) {
            ...
            if (PluralAttribute.CollectionType.MAP.equals(pluralAttribute.getCollectionType())) {
                return (PluralAttributePath<Y>) this.<Object, Object, Map<Object, Object>>get(
