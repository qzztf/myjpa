 ...
 */
public class SimpleCaseExpression<C, R> extends ExpressionImpl<R> implements SimpleCase<C, R>, Serializable {
    ...
    public SimpleCaseExpression(CriteriaBuilderImpl criteriaBuilder, Class<R> javaType,
    ...
    public String render(RenderingContext renderingContext) {
        ...
        caseExpr.append("case ").append(((Renderable) getExpression()).render(renderingContext));

        for (WhenClause whenClause : getWhenClauses()) {
            caseExpr.append(" when ").append(whenClause.getCondition().render(renderingContext)).append(" then ")
                    .append(((Renderable) whenClause.getResult()).render(renderingContext));
        }

        caseExpr.append(" else ").append(((Renderable) getOtherwiseResult()).render(renderingContext)).append(" end");
