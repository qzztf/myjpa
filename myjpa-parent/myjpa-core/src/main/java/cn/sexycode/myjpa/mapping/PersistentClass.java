    ...
    public Class getProxyInterface() {
        ...
        try {
            if (proxyInterface == null) {
                proxyInterface = metadataBuildingContext.getBootstrapContext().getClassLoaderAccess()
                        .classForName(proxyInterfaceName);
            }
...
*/
    private Property getProperty(String propertyName, Iterator iterator) throws MappingException {
        if (iterator.hasNext()) {
            String root = StringUtils.root(propertyName);
    ...
    public Property getProperty(String propertyName) throws MappingException {
        ...
        Property identifierProperty = getIdentifierProperty();
        if (identifierProperty != null && identifierProperty.getName().equals(StringUtils.root(propertyName))) {
    ...
    public boolean isPropertyDefinedInHierarchy(String name) {
        ...
        if (getSuperclass() != null && getSuperclass().isPropertyDefinedInHierarchy(name)) {
            return true;
        }
    ...
    public void validate(Mapping mapping) throws MappingException {
        ...
        while (iter.hasNext()) {
            ...
            if (!prop.isValid(mapping)) {
                throw new MappingException("property mapping has wrong number of columns: " + StringUtils
                        .qualify(getEntityName(), prop.getName()) + " type: " + prop.getType().getName());
            }
        }
        ...
        while (columns.hasNext()) {
            ...
            if (!columnOrFormula.isFormula()) {
                ...
                if (!distinctColumns.add(col.getName())) {
                    throw new MappingException(
                            "Repeated column in mapping for entity: " + getEntityName() + " column: " + col.getName()
