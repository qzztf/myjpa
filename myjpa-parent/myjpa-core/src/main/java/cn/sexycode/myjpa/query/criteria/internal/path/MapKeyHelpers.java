...
import cn.sexycode.myjpa.query.criteria.internal.MapJoinImplementor;
...
public class MapKeyHelpers {
    ...
    public static class MapKeyPath<K> extends AbstractPathImpl<K> implements PathImplementor<K>, Serializable {
        ...
        public MapKeyPath(CriteriaBuilderImpl criteriaBuilder, MapKeySource<K, ?> source,
     ...
     */
    public static class MapKeySource<K, V> extends AbstractPathImpl<Map<K, V>>
        ...
        public MapKeySource(CriteriaBuilderImpl criteriaBuilder, Class<Map<K, V>> javaType,
                MapJoinImplementor<?, K, V> mapJoin, MapAttribute<?, K, V> attribute) {
...
//        private final PersistentAttributeType persistentAttributeType;
        ...
        public MapKeyAttribute(CriteriaBuilderImpl criteriaBuilder, MapAttribute<?, K, ?> attribute) {
            ...
            this.jpaBindableType = Type.PersistenceType.ENTITY.equals(jpaType.getPersistenceType())
