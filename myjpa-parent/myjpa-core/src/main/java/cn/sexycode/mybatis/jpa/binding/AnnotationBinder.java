...
public final class AnnotationBinder {
    ...
    private static IdentifierGeneratorDefinition buildIdGenerator(Annotation ann, MetadataBuildingContext context) {
        if (ann == null) {
            return null;
        }
    ...
    public static void bindClass(
        ...
        cn.sexycode.mybatis.jpa.mapping.Table tabAnn = null;
        if (clazzToProcess.isAnnotationPresent(cn.sexycode.mybatis.jpa.mapping.Table.class)) {
            tabAnn = clazzToProcess.getAnnotation(cn.sexycode.mybatis.jpa.mapping.Table.class);
            table = tabAnn.name();
    ...
    private static int addProperty(
        ...
        if (element.isAnnotationPresent(Id.class) || element.isAnnotationPresent(EmbeddedId.class)) {
            ...
            if (context.getBuildingOptions().isSpecjProprietarySyntaxEnabled()) {
                if (element.isAnnotationPresent(Id.class) && element.isAnnotationPresent(cn.sexycode.mybatis.jpa.mapping.Column.class)) {
                    String columnName = element.getAnnotation(cn.sexycode.mybatis.jpa.mapping.Column.class).name();
    ...
    private static void processElementAnnotations(
        ...
        if (property.isAnnotationPresent(Version.class)) {
            ...
            if (property.isAnnotationPresent(ManyToOne.class)) {
                ...
                //check validity
                if (property.isAnnotationPresent(cn.sexycode.mybatis.jpa.mapping.Column.class)
                ...
                if (property.isAnnotationPresent(cn.sexycode.mybatis.jpa.mapping.Column.class) || property.isAnnotationPresent(
                        Formula.class
                )) {
                    cn.sexycode.mybatis.jpa.mapping.Column ann = property.getAnnotation(cn.sexycode.mybatis.jpa.mapping.Column.class);
                    Formula formulaAnn = property.getAnnotation(Formula.class);
                    elementColumns = Ejb3Column.buildColumnFromAnnotation(
                            new cn.sexycode.mybatis.jpa.mapping.Column[]{ann},
                            formulaAnn,
                            nullability,
                            propertyHolder,
                            virtualProperty,
                ...
                {
                    cn.sexycode.mybatis.jpa.mapping.Column[] keyColumns = null;
                    //JPA 2 has priority and has different default column values, differenciate legacy from JPA 2
                    Boolean isJPA2 = null;
                    if (property.isAnnotationPresent(MapKeyColumn.class)) {
                        isJPA2 = Boolean.TRUE;
                        keyColumns = new cn.sexycode.mybatis.jpa.mapping.Column[]{new MapKeyColumnDelegator(property.getAnnotation(MapKeyColumn.class))};
                    }
    ...
    private static void bindManyToOne(
        ...
        if (context.getBuildingOptions().isSpecjProprietarySyntaxEnabled()) {
            ...
            for (XProperty prop : inferredData.getDeclaringClass()
                ...
                if (prop.isAnnotationPresent(Id.class) && prop.isAnnotationPresent(cn.sexycode.mybatis.jpa.mapping.Column.class)) {
                    columnName = prop.getAnnotation(cn.sexycode.mybatis.jpa.mapping.Column.class).name();
                }
...
//			return true;
        ...
        for (XProperty property : properties) {
            if (property.isAnnotationPresent(cn.sexycode.mybatis.jpa.mapping.Column.class) || property.isAnnotationPresent(OneToMany.class) ||
