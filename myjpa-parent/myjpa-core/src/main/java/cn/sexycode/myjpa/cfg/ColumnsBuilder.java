...
import cn.sexycode.myjpa.binding.EntityBinder;
...
class ColumnsBuilder {
    ...
    public ColumnsBuilder(PropertyHolder propertyHolder, Nullability nullability, XProperty property,
            PropertyData inferredData, EntityBinder entityBinder, MetadataBuildingContext buildingContext) {
    ...
    public ColumnsBuilder extractMetadata() {
        ...
        if (joinColumns == null && (property.isAnnotationPresent(ManyToOne.class) || property
                .isAnnotationPresent(OneToOne.class))) {
            joinColumns = buildDefaultJoinColumnsForXToOne(property, inferredData);
        } else if (joinColumns == null && (property.isAnnotationPresent(OneToMany.class) || property
    ...
    Ejb3JoinColumn[] buildExplicitJoinColumns(XProperty property, PropertyData inferredData) {
        ...
        if (joinColumnAnnotations != null) {
            return Ejb3JoinColumn
                    .buildJoinColumns(joinColumnAnnotations, null, entityBinder.getSecondaryTables(), propertyHolder,
                            inferredData.getPropertyName(), buildingContext);
        }
        ...
        if (property.isAnnotationPresent(JoinColumnOrFormula.class)) {
            ...
            JoinColumnsOrFormulas joinColumnsOrFormulasAnnotations = property
                    .getAnnotation(JoinColumnsOrFormulas.class);
