...
public class ImplicitNamingStrategyJpaCompliantImpl implements ImplicitNamingStrategy, Serializable {
    ...
    public Identifier determinePrimaryTableName(ImplicitEntityNameSource source) {
        if (source == null) {
            ...
            throw new MyjpaException("Entity naming information was not provided.");
        }
        ...
        if (tableName == null) {
            ...
            throw new MyjpaException("Could not determine primary table name for entity");
        }
    ...
    protected String transformEntityName(EntityNaming entityNaming) {
        ...
        if (StringUtils.isNotEmpty(entityNaming.getJpaEntityName())) {
            return entityNaming.getJpaEntityName();
        } else {
            // otherwise, use the Hibernate entity name
            return StringUtils.unqualify(entityNaming.getEntityName());
        }
    }
...
*/
    ...
    protected Identifier toIdentifier(String stringForm, MetadataBuildingContext buildingContext) {
        return buildingContext.getMetadataCollector().getDatabase().getEnvironment().getIdentifierHelper()
