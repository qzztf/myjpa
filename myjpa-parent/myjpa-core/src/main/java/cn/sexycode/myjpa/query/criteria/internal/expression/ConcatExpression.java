...
public class ConcatExpression extends ExpressionImpl<String> implements Serializable {
    ...
    public ConcatExpression(CriteriaBuilderImpl criteriaBuilder, Expression<String> expression1,
    ...
    public String render(RenderingContext renderingContext) {
        return '(' + ((Renderable) getString1()).render(renderingContext) + " || " + ((Renderable) getString2())
