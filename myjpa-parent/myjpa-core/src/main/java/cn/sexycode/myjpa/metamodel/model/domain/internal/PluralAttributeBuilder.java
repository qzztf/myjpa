...
public class PluralAttributeBuilder<D, C, E, K> {
    ...
    public PluralAttributeBuilder(ManagedTypeDescriptor<D> ownerType, SimpleTypeDescriptor<E> elementType,
            Class<C> collectionClass, SimpleTypeDescriptor<K> keyType) {
    ...
    public AbstractPluralAttribute<D, C, E> build() {
        ...
        if (Map.class.equals(collectionClass)) {
            ...
            return (AbstractPluralAttribute<D, C, E>) new MapAttributeImpl<>(builder);
            ...
            return (AbstractPluralAttribute<D, C, E>) new SetAttributeImpl<>(builder);
        } else if (List.class.equals(collectionClass)) {
            final PluralAttributeBuilder<D, List<E>, E, ?> builder = (PluralAttributeBuilder<D, List<E>, E, ?>) this;
            return (AbstractPluralAttribute<D, C, E>) new ListAttributeImpl<>(builder);
            ...
            return (AbstractPluralAttribute<D, C, E>) new BagAttributeImpl<>(builder);
        }
