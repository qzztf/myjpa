...
public abstract class EntityType extends AbstractType implements AssociationType {
     ...
     *                              with lazy="no-proxy".
     */
    protected EntityType(TypeFactory.TypeScope scope, String entityName, boolean referenceToPrimaryKey,
            String uniqueKeyPropertyName, boolean eager, boolean unwrapProxy) {
        this.scope = scope;
     ...
     */
    @Override
    public String getAssociatedEntityName(SessionFactory factory) {
     ...
     */
	/*@Override
	public Joinable getAssociatedJoinable(SessionFactory factory) throws MappingException {
...
/*
    ...
    @Override
    public Object deepCopy(Object value, SessionFactory factory) {
    ...
    public Object replace(Object original, Object target, SharedSessionContractImplementor session, Object owner,
        ...
        if (cached != null) {
            ...
            if (session.getContextEntityIdentifier(original) == null && ForeignKeys
    ...
    @Override
    public int getHashCode(Object x, SessionFactory factory) {
    ...
    @Override
    public boolean isEqual(Object x, Object y, SessionFactory factory) {
    ...
    @Override
    public String getOnCondition(String alias, SessionFactory factory, Map enabledFilters) {
    ...
    @Override
    public Type getSemiResolvedType(SessionFactory factory) {
        return getAssociatedEntityPersister(factory).getIdentifierType();
    }

    protected EntityPersister getAssociatedEntityPersister(final SessionFactory factory) {
    ...
    protected final Object getIdentifier(Object value, SharedSessionContractImplementor session)
        ...
        if (isReferenceToPrimaryKey() || uniqueKeyPropertyName == null) {
            return ForeignKeys
                    .getEntityIdentifierIfNotUnsaved(getAssociatedEntityName(), value, session); //tolerates nulls
        } else if (value == null) {
            return null;
        } else {
     ...
     */
    @Override
    public String toLoggableString(Object value, SessionFactory factory) {
        if (value == null) {
            return "null";
        }
     ...
     */
    protected final Object resolveIdentifier(Serializable id, SharedSessionContractImplementor session,
        ...
        Object proxyOrEntity = session.internalLoad(getAssociatedEntityName(), id, eager, isNullable(), unwrapProxy);
     ...
     */
    public Object loadByUniqueKey(String entityName, String uniqueKeyPropertyName, Object key,
        ...
        EntityUniqueKey euk = new EntityUniqueKey(entityName, uniqueKeyPropertyName, key,
                getIdentifierOrUniqueKeyType(factory), persister.getEntityMode(), session.getFactory());
    ...
    protected Type requireIdentifierOrUniqueKeyType(Mapping mapping) {
        ...
        if (fkTargetType == null) {
            throw new MappingException("Unable to determine FK target Type for many-to-one or one-to-one mapping: "
                    + "referenced-entity-name=[" + getAssociatedEntityName() + "], referenced-entity-attribute-name=["
                    + getLHSPropertyName() + "]");
        }
        return fkTargetType;
    }
