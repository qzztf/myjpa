...
import cn.sexycode.myjpa.query.criteria.internal.expression.*;
import cn.sexycode.myjpa.query.criteria.internal.expression.function.*;
...
public class CriteriaBuilderImpl implements HibernateCriteriaBuilder, Serializable {
    ...
    public Predicate isTrue(Expression<Boolean> expression) {
        if (CompoundPredicate.class.isInstance(expression)) {
            ...
            if (predicate.getExpressions().size() == 0) {
                return new BooleanStaticAssertionPredicate(this,
    ...
    public <N extends Number> Expression<N> sum(Expression<? extends N> expression1,
        ...
        final Class resultType = BinaryArithmeticOperation
                .determineResultType(expression1.getJavaType(), expression2.getJavaType());

        return new BinaryArithmeticOperation<N>(this, resultType, BinaryArithmeticOperation.Operation.ADD, expression1,
                expression2);
    }
    ...
    public <N extends Number> Expression<N> prod(Expression<? extends N> expression1,
        ...
        return new BinaryArithmeticOperation<N>(this, resultType, BinaryArithmeticOperation.Operation.MULTIPLY,
    ...
    public <N extends Number> Expression<N> diff(Expression<? extends N> expression1,
        ...
        return new BinaryArithmeticOperation<N>(this, resultType, BinaryArithmeticOperation.Operation.SUBTRACT,
                expression1, expression2);
    }
    ...
    public <N extends Number> Expression<N> sum(Expression<? extends N> expression, N n) {
        ...
        return new BinaryArithmeticOperation<N>(this, resultType, BinaryArithmeticOperation.Operation.ADD, expression,
                n);
    }
    ...
    public <N extends Number> Expression<N> sum(N n, Expression<? extends N> expression) {
        ...
        return new BinaryArithmeticOperation<N>(this, resultType, BinaryArithmeticOperation.Operation.ADD, n,
                expression);
    }
    ...
    public <N extends Number> Expression<N> prod(N n, Expression<? extends N> expression) {
        ...
        return (BinaryArithmeticOperation<N>) new BinaryArithmeticOperation(this, resultType,
                BinaryArithmeticOperation.Operation.MULTIPLY, n, expression);
    }
    ...
    public <N extends Number> Expression<N> diff(N n, Expression<? extends N> expression) {
        ...
        return new BinaryArithmeticOperation<N>(this, resultType, BinaryArithmeticOperation.Operation.SUBTRACT, n,
                expression);
    }
    ...
    public Expression<Number> quot(Expression<? extends Number> expression1, Expression<? extends Number> expression2) {
        ...
        final Class resultType = BinaryArithmeticOperation
                .determineResultType(expression1.getJavaType(), expression2.getJavaType(), true);

        return new BinaryArithmeticOperation<Number>(this, resultType, BinaryArithmeticOperation.Operation.DIVIDE,
                expression1, expression2);
    }
    ...
    public Expression<Number> quot(Expression<? extends Number> expression, Number number) {
        ...
        final Class resultType = BinaryArithmeticOperation
                .determineResultType(expression.getJavaType(), number.getClass(), true);
    ...
    public Expression<Number> quot(Number number, Expression<? extends Number> expression) {
        ...
        final Class resultType = BinaryArithmeticOperation
                .determineResultType(number.getClass(), expression.getJavaType(), true);
    ...
    public Expression<Integer> mod(Expression<Integer> expression1, Expression<Integer> expression2) {
        ...
        return new BinaryArithmeticOperation<Integer>(this, Integer.class, BinaryArithmeticOperation.Operation.MOD,
                expression1, expression2);
    }
    ...
    public <Y> Expression<Y> all(Subquery<Y> subquery) {
        return new SubqueryComparisonModifierExpression<Y>(this, (Class<Y>) subquery.getJavaType(), subquery,
    ...
    public <E, C extends Collection<E>> Predicate isMember(Expression<E> elementExpression,
        ...
        return new MemberOfPredicate<>(this, elementExpression, (PluralAttributePath<C>) collectionExpression);
    }
    ...
    @SuppressWarnings("unchecked")
    private <X, T, V extends T, K extends JoinImplementor> K treat(Join<X, T> join, Class<V> type,
