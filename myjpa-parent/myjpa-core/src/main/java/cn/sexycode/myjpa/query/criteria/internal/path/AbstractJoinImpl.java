...
import cn.sexycode.myjpa.query.criteria.internal.predicate.PredicateImplementor;
 ...
 */
public abstract class AbstractJoinImpl<Z, X> extends AbstractFromImpl<Z, X>
    ...
    public AbstractJoinImpl(CriteriaBuilderImpl criteriaBuilder, PathSource<Z> pathSource,
            Attribute<? super Z, X> joinAttribute, JoinType joinType) {
        this(criteriaBuilder, joinAttribute.getJavaType(), pathSource, joinAttribute, joinType);
    }

    public AbstractJoinImpl(CriteriaBuilderImpl criteriaBuilder, Class<X> javaType, PathSource<Z> pathSource,
            Attribute<? super Z, ?> joinAttribute, JoinType joinType) {
    ...
    public String renderTableExpression(RenderingContext renderingContext) {
        ...
        tableExpression.append(getParent().getAlias()).append('.').append(getAttribute().getName()).append(" as ")
                .append(getAlias());
