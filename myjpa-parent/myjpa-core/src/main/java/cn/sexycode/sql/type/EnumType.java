...
public class EnumType implements EnhancedUserType, DynamicParameterizedType, LoggableUserType, Serializable {
    ...
    public void setParameterValues(Properties parameters) {
        ...
        if (reader != null) {
            ...
            try {
                ...
                throw new TypeException("Enum class not found: " + enumClassName, exception);
            }
    ...
    @Override
    public boolean equals(Object x, Object y) throws TypeException {
        return x == y;
    }

    @Override
    public int hashCode(Object x) throws TypeException {
    ...
    @Override
    public Object deepCopy(Object value) throws TypeException {
        return value;
    }
    ...
    @Override
    public Serializable disassemble(Object value) throws TypeException {
        return (Serializable) value;
    }

    @Override
    public Object assemble(Serializable cached, Object owner) throws TypeException {
        return cached;
    }

    @Override
    public Object replace(Object original, Object target, Object owner) throws TypeException {
        return original;
    }
    ...
    private class OrdinalEnumValueMapper extends EnumValueMapperSupport implements EnumValueMapper, Serializable {
        ...
        private Enum[] enumsByOrdinal() {
            if (enumsByOrdinal == null) {
                ...
                if (enumsByOrdinal == null) {
                    throw new TypeException("Failed to init enum values");
                }
            }
