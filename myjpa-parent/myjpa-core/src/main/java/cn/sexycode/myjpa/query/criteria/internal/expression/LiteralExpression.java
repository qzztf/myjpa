...
import cn.sexycode.myjpa.query.criteria.internal.ValueHandlerFactory.ValueHandler;
...
//                    literalValue = renderingContext.getDialect().inlineLiteral((String) literal);
    ...
    private String renderProjection(RenderingContext renderingContext) {
        ...
        final ValueHandlerFactory.ValueHandler handler = ValueHandlerFactory
                .determineAppropriateHandler(literal.getClass());
