...
import cn.sexycode.myjpa.query.criteria.internal.path.MapAttributeJoin;
 ...
 */
public class MapEntryExpression<K, V> extends ExpressionImpl<Map.Entry<K, V>>
        implements CompoundSelection<Map.Entry<K, V>>, Serializable {

    private final MapAttributeJoin<?, K, V> original;

    public MapEntryExpression(CriteriaBuilderImpl criteriaBuilder, Class<Map.Entry<K, V>> javaType,
