    ...
    public static void bindPackage(String packageName, MetadataBuildingContext context) {
        ...
        if (pckg.isAnnotationPresent(SequenceGenerator.class)) {
            ...
            if (LOG.isTraceEnabled()) {
                //				LOG.trace( "Add sequence generator with name: {0}", idGen.getName() );
            }
        }
...
*/
    ...
    public static void bindClass(XClass clazzToProcess, Map<XClass, InheritanceState> inheritanceStatePerClass,
        ...
        if (clazzToProcess.isAnnotationPresent(Entity.class) && clazzToProcess
        ...
        for (XClass clazz : orderedClasses) {
            ...
            if (superclassState != null) {
                ...
                final boolean nonDefault =
                        state.getType() != null && !InheritanceType.SINGLE_TABLE.equals(state.getType());
                if (superclassState.getType() != null) {
                    final boolean mixingStrategy =
                            state.getType() != null && !state.getType().equals(superclassState.getType());
