...
public final class ProviderChecker {
    ...
    private static final Logger log = LoggerFactory.getLogger(ProviderChecker.class);
    ...
    public static boolean hibernateProviderNamesContain(String requestedProviderName) {
        log.trace("Checking requested PersistenceProvider name [{}] against Hibernate provider names",
        ...
        return MyjpaPersistenceProvider.class.getName().equals(requestedProviderName);
    }
    ...
    public static String extractRequestedProviderName(PersistenceUnitDescriptor persistenceUnit, Map integration) {
        ...
        if (integrationProviderName != null) {
            log.debug("Integration provided explicit PersistenceProvider [{}]", integrationProviderName);
        ...
        if (persistenceUnitRequestedProvider != null) {
            log.debug("Persistence-unit [{}] requested PersistenceProvider [{}]", persistenceUnit.getName(),
        ...
        return MyjpaPersistenceProvider.class.getName();
    }
