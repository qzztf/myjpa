...
import cn.sexycode.myjpa.sql.type.ArrayType;
import cn.sexycode.myjpa.sql.type.CustomType;
import cn.sexycode.myjpa.sql.type.ListType;
...
/**
 * Used internally to build instances of {@link cn.sexycode.myjpa.sql.type.Type}, specifically it builds instances of
 * <p/>
 * <p/>
...
public final class TypeFactory implements Serializable {
    ...
    public cn.sexycode.myjpa.sql.type.Type byClass(Class clazz, Properties parameters) {
        if (cn.sexycode.myjpa.sql.type.Type.class.isAssignableFrom(clazz)) {
            return type(clazz, parameters);
        }


        if (cn.sexycode.myjpa.sql.type.UserType.class.isAssignableFrom(clazz)) {
    ...
    public cn.sexycode.myjpa.sql.type.Type type(Class<cn.sexycode.myjpa.sql.type.Type> typeClass, Properties parameters) {
        try {
            cn.sexycode.myjpa.sql.type.Type type = typeClass.newInstance();
    ...
    public cn.sexycode.myjpa.sql.type.CustomType custom(Class<cn.sexycode.myjpa.sql.type.UserType> typeClass, Properties parameters) {
        return custom(typeClass, parameters, typeScope);
    }

    /**
     * @deprecated Only for use temporary use
     */
    @Deprecated
    public static cn.sexycode.myjpa.sql.type.CustomType custom(Class<cn.sexycode.myjpa.sql.type.UserType> typeClass, Properties parameters, TypeScope scope) {
        try {
    ...
    public cn.sexycode.myjpa.sql.type.Type any(cn.sexycode.myjpa.sql.type.Type metaType, Type identifierType) {
