...
public class OrdinalEnumValueConverter<E extends Enum> implements EnumValueConverter<E, Integer>, Serializable {
    ...
    private static <T extends Enum> ValueExtractor<T> createValueExtractor(
            EnumJavaTypeDescriptor<T> enumJavaDescriptor) {
    ...
    private static ValueBinder<Integer> createValueBinder() {
        return IntegerTypeDescriptor.INSTANCE
                .getBinder(org.hibernate.type.descriptor.java.IntegerTypeDescriptor.INSTANCE);
    }
