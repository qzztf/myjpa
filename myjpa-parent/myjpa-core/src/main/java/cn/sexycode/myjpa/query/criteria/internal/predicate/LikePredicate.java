...
public class LikePredicate extends AbstractSimplePredicate implements Serializable {
    ...
    public LikePredicate(CriteriaBuilderImpl criteriaBuilder, Expression<String> matchExpression,
    ...
    public LikePredicate(CriteriaBuilderImpl criteriaBuilder, Expression<String> matchExpression,
            Expression<String> pattern, Expression<Character> escapeCharacter) {
    ...
    public LikePredicate(CriteriaBuilderImpl criteriaBuilder, Expression<String> matchExpression,
        ...
        this(criteriaBuilder, matchExpression, pattern,
    ...
    public String render(boolean isNegated, RenderingContext renderingContext) {
        ...
        if (escapeCharacter != null) {
            buffer.append(" escape ").append(((Renderable) getEscapeCharacter()).render(renderingContext));
        }
