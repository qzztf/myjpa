...
import cn.sexycode.myjpa.metamodel.model.domain.spi.SingularPersistentAttribute;
 ...
 */
public class SingularAttributeImpl<D, J> extends AbstractAttribute<D, J>
    ...
    public SingularAttributeImpl(ManagedTypeDescriptor<D> declaringType, String name,
            PersistentAttributeType attributeNature, SimpleTypeDescriptor<J> attributeType, Member member,
            boolean isIdentifier, boolean isVersion, boolean isOptional) {
    ...
    public static class Identifier<D, J> extends SingularAttributeImpl<D, J> {
        public Identifier(ManagedTypeDescriptor<D> declaringType, String name, SimpleTypeDescriptor<J> attributeType,
                Member member, PersistentAttributeType attributeNature) {
    ...
    public static class Version<X, Y> extends SingularAttributeImpl<X, Y> {
        public Version(ManagedTypeDescriptor<X> declaringType, String name, PersistentAttributeType attributeNature,
                SimpleTypeDescriptor<Y> attributeType, Member member) {
