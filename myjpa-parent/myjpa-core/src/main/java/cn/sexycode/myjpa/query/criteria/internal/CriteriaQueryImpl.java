...
public class CriteriaQueryImpl<T> extends AbstractNode implements CriteriaQuery<T>, CompilableCriteria, Serializable {
    private static final Logger log = LoggerFactory.getLogger(CriteriaQueryImpl.class);
    ...
    public CriteriaInterpretation interpret(RenderingContext renderingContext) {
        ...
        return new CriteriaInterpretation() {
            ...
            public QueryImplementor buildCompiledQuery(SharedSessionContractImplementor entityManager,
                ...
                return new CriteriaQueryTypeQueryAdapter(entityManager, jpaqlQuery,
    ...
    protected void renderOrderByClause(RenderingContext renderingContext, StringBuilder jpaqlBuffer) {
        ...
        try {
            ...
            for (Order orderSpec : getOrderList()) {
                jpaqlBuffer.append(sep).append(((Renderable) orderSpec.getExpression()).render(renderingContext))
