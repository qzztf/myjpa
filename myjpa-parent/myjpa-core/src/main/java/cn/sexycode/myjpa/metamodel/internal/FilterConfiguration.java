...
public class FilterConfiguration {
    ...
    public FilterConfiguration(String name, String condition, boolean autoAliasInjection,
            Map<String, String> aliasTableMap, Map<String, String> aliasEntityMap, PersistentClass persistentClass) {
        this.name = name;
    ...
    public Map<String, String> getAliasTableMap(SessionFactory factory) {
    ...
    private Map<String, String> mergeAliasMaps(SessionFactory factory) {
