...
class PropertyContainer {
    ...
    private void collectPersistentAttributesUsingLocalAccessType(TreeMap<String, XProperty> persistentAttributeMap,
    ...
    private void collectPersistentAttributesUsingClassLevelAccessType(TreeMap<String, XProperty> persistentAttributeMap,
            Map<String, XProperty> persistentAttributesFromGetters, List<XProperty> fields, List<XProperty> getters) {
    ...
    private void assertTypesAreResolvable() {
        for (XProperty xProperty : persistentAttributeMap.values()) {
            if (!xProperty.isTypeResolved() && !discoverTypeWithoutReflection(xProperty)) {
                String msg = "Property " + StringUtils.qualify(xClass.getName(), xProperty.getName())
    ...
    private AccessType determineLocalClassDefinedAccessStrategy() {
		...
		/*javax.persistence.AccessType accessType = xClass.getAnnotation( javax.persistence.AccessType.class );
		if ( accessType != null ) {
    ...
    private static boolean discoverTypeWithoutReflection(XProperty p) {
        if (p.isAnnotationPresent(OneToOne.class) && !p.getAnnotation(OneToOne.class).targetEntity()
            ...
            return p.isAnnotationPresent(ManyToMany.class) && !p.getAnnotation(ManyToMany.class).targetEntity()
                    .equals(void.class);
    ...
    private static boolean mustBeSkipped(XProperty property) {
        ...
        return property.isAnnotationPresent(Transient.class) || "net.sf.cglib.transform.impl.InterceptFieldCallback"
                .equals(property.getType().getName()) || "org.hibernate.bytecode.internal.javassist.FieldHandler"
