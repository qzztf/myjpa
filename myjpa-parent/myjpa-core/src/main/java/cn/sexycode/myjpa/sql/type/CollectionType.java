...
import cn.sexycode.myjpa.sql.type.AssociationType;
...
import cn.sexycode.myjpa.sql.util.MarkerObject;
...
public abstract class CollectionType extends AbstractType implements AssociationType {
    ...
    private final cn.sexycode.myjpa.sql.type.TypeFactory.TypeScope typeScope;
    ...
    public Object nullSafeGet(ResultSet rs, String[] name, Object owner)
            throws cn.sexycode.myjpa.sql.type.TypeException, SQLException {
        return null;
    }


    @Override
    public void nullSafeSet(PreparedStatement st, Object value, int index) throws cn.sexycode.myjpa.sql.type.TypeException, SQLException {
    }

    @Override
    public int[] sqlTypes(cn.sexycode.myjpa.sql.type.Mapping session) throws MappingException {
    ...
    @Override
    public int getColumnSpan(cn.sexycode.myjpa.sql.type.Mapping session) throws MappingException {
        return 0;
    }
