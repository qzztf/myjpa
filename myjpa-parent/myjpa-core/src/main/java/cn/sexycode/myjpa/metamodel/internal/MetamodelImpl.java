...
public class MetamodelImpl implements MetamodelImplementor, Serializable {
	 ...
	 */
	public void initialize(Metadata mappingMetadata, JpaMetaModelPopulationSetting jpaMetaModelPopulationSetting) {
...
/*
	...
	private void primeSecondLevelCacheRegions(Metadata mappingMetadata) {
...
*/
	...
	public Set<ManagedType<?>> getManagedTypes() {
		final int setSize = CollectionUtils.determineProperSizing(
