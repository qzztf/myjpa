...
import cn.sexycode.myjpa.sql.dialect.ColumnAliasExtractor;
import cn.sexycode.myjpa.sql.dialect.Dialect;
import cn.sexycode.myjpa.sql.dialect.DialectException;
import cn.sexycode.myjpa.sql.dialect.TypeNames;
...
import cn.sexycode.myjpa.sql.dialect.pagination.LegacyLimitHandler;
...
import cn.sexycode.myjpa.sql.type.StandardBasicTypes;
 ...
 *
 */
public abstract class AbstractDialect implements cn.sexycode.myjpa.sql.dialect.Dialect {
    ...
    private final cn.sexycode.myjpa.sql.dialect.TypeNames typeNames = new cn.sexycode.myjpa.sql.dialect.TypeNames();
    private final cn.sexycode.myjpa.sql.dialect.TypeNames hibernateTypeNames = new TypeNames();
...
*/
     ...
     */
    public static cn.sexycode.myjpa.sql.dialect.Dialect getDialect() throws DialectException {
     ...
     * @throws DialectException If no dialect was specified, or if it could not be instantiated.
     */
    public static cn.sexycode.myjpa.sql.dialect.Dialect getDialect(Properties props) throws DialectException {
    ...
    private static cn.sexycode.myjpa.sql.dialect.Dialect instantiateDialect(String dialectName) throws DialectException {
        if (dialectName == null) {
