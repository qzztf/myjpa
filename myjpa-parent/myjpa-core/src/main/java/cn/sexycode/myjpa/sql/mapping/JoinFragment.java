...
public abstract class JoinFragment {
	 ...
	 *
	 * @deprecated use {@link cn.sexycode.myjpa.sql.mapping.JoinType#INNER_JOIN} instead.
	 */
	@Deprecated
	public static final int INNER_JOIN = cn.sexycode.myjpa.sql.mapping.JoinType.INNER_JOIN.getJoinTypeValue();

	/**
	 * Specifies a full join
	 *
	 * @deprecated use {@link cn.sexycode.myjpa.sql.mapping.JoinType#FULL_JOIN} instead.
	 */
	@Deprecated
	@SuppressWarnings("UnusedDeclaration")
	public static final int FULL_JOIN = cn.sexycode.myjpa.sql.mapping.JoinType.FULL_JOIN.getJoinTypeValue();

	/**
	 * Specifies a left join.
	 *
	 * @deprecated use {@link cn.sexycode.myjpa.sql.mapping.JoinType#LEFT_OUTER_JOIN} instead.
	 */
	@Deprecated
	public static final int LEFT_OUTER_JOIN = cn.sexycode.myjpa.sql.mapping.JoinType.LEFT_OUTER_JOIN.getJoinTypeValue();

	/**
	 * Specifies a right join.
	 *
	 * @deprecated use {@link cn.sexycode.myjpa.sql.mapping.JoinType#RIGHT_OUTER_JOIN} instead.
	 */
	@Deprecated
	@SuppressWarnings("UnusedDeclaration")
	public static final int RIGHT_OUTER_JOIN = cn.sexycode.myjpa.sql.mapping.JoinType.RIGHT_OUTER_JOIN.getJoinTypeValue();
	 ...
	 */
	public abstract void addJoin(String tableName, String alias, String[] fkColumns, String[] pkColumns, cn.sexycode.myjpa.sql.mapping.JoinType joinType);
	 ...
	 */
	public abstract void addJoin(String tableName, String alias, String[] fkColumns, String[] pkColumns, cn.sexycode.myjpa.sql.mapping.JoinType joinType, String on);
