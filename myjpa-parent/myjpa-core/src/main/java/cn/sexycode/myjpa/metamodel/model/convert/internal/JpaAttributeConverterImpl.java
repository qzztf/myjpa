 ...
 */
package cn.sexycode.myjpa.metamodel.model.convert.internal;
...
public class JpaAttributeConverterImpl<O, R> implements JpaAttributeConverter<O, R> {
    ...
    public JpaAttributeConverterImpl(ManagedBean<AttributeConverter<O, R>> attributeConverterBean,
            JavaTypeDescriptor<AttributeConverter<O, R>> converterJavaTypeDescriptor,
            JavaTypeDescriptor<O> domainJavaTypeDescriptor, JavaTypeDescriptor<R> relationalJavaTypeDescriptor) {
